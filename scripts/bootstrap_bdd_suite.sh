...
echo "  2. python -m src.agents.testcase_generator data/requirements/${STEM}.md"
echo "  3. python -m src.agents.playwright_generator output/testcase_generated/${STEM}_raw_output.json"
